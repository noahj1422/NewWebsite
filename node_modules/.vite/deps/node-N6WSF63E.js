  ...
  "node_modules/lightningcss/node/composeVisitors.js"(exports, module) {
    ...
    function ruleVisitor(f, item) {
      ...
      if (typeof f === "object") {
        if (item.type === "unknown") {
          ...
          return v == null ? void 0 : v(item.value);
        }
        if (item.type === "custom") {
          let v = f.custom;
          if (typeof v === "object") {
        ...
        return (_a = f[item.type]) == null ? void 0 : _a.call(f, item);
      }
      return f == null ? void 0 : f(item);
    }
    function declarationVisitor(f, item) {
      ...
      if (typeof f === "object") {
        ...
        return (_a = f[name]) == null ? void 0 : _a.call(f, item);
      }
      return f == null ? void 0 : f(item);
    }
        ...
        if (typeof options.visitor === "function") {
          ...
          if (result instanceof Promise) {
            result = result.then((res) => {
              if (deps.length) {
                res.dependencies ?? (res.dependencies = []);
...
//# sourceMappingURL=node-N6WSF63E.js.map
